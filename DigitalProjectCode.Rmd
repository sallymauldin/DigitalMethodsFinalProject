...
````{r, message=FALSE, warning=FALSE, echo=FALSE}
#Customize the nodes by color in network. Nodes are all of the people and each of the 22 institutions. Total of 319 nodes.
nodes <- nodes %>%
  mutate(title = (nodes$ID[1:319])) %>%
...
visNetwork(nodes = nodes$ID, edges = edges$Relationship, height = 650, width = 1100) %>%
